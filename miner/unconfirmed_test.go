...
func (r *noopChainRetriever) GetHeaderByNumber(number uint64) *types.Header[nist.PublicKey] {
	return nil
}
...
func TestUnconfirmedInsertBounds(t *testing.T) {
	...
	pool := newUnconfirmedBlocks[nist.PublicKey](new(noopChainRetriever), limit)

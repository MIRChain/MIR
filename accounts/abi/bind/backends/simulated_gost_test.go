...
func TestSimulatedBackendGost(t *testing.T) {
	...
	key, _ := crypto.GenerateKey[gost3410.PrivateKey]() // nolint: gosec
	auth, _ := bind.NewKeyedTransactorWithChainID[gost3410.PrivateKey, gost3410.PublicKey](key, big.NewInt(1337))
	...
	tx, _ = types.SignTx[gost3410.PrivateKey, gost3410.PublicKey](tx, types.HomesteadSigner[gost3410.PublicKey]{}, key)
...
//	 	}
//	 }
const abiJSONGost = `[ { "constant": false, "inputs": [ { "name": "memo", "type": "bytes" } ], "name": "receive", "outputs": [ { "name": "res", "type": "string" } ], "payable": true, "stateMutability": "payable", "type": "function" }, { "anonymous": false, "inputs": [ { "indexed": false, "name": "sender", "type": "address" }, { "indexed": false, "name": "amount", "type": "uint256" }, { "indexed": false, "name": "memo", "type": "bytes" } ], "name": "received", "type": "event" }, { "anonymous": false, "inputs": [ { "indexed": false, "name": "sender", "type": "address" } ], "name": "receivedAddr", "type": "event" } ]`
const abiBinGost = ``
const deployedCodeGost = ``
...
func simTestBackendGost(testAddr common.Address) *SimulatedBackend[gost3410.PublicKey] {
...
func TestNewSimulatedBackendGost(t *testing.T) {
...
func TestSimulatedBackendGost_AdjustTime(t *testing.T) {
...
func TestNewSimulatedBackendGost_AdjustTimeFail(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
	sim := simTestBackendGost(testAddr)
	// Create tx and send
...
func TestSimulatedBackendGost_BalanceAt(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
	expectedBal := big.NewInt(10000000000)
	sim := simTestBackendGost(testAddr)
	defer sim.Close()
...
func TestSimulatedBackendGost_BlockByHash(t *testing.T) {
	sim := NewSimulatedBackend[gost3410.PublicKey](
		core.GenesisAlloc{}, 10000000,
	)
	defer sim.Close()
...
func TestSimulatedBackendGost_BlockByNumber(t *testing.T) {
	sim := NewSimulatedBackend[gost3410.PublicKey](
		core.GenesisAlloc{}, 10000000,
	)
	defer sim.Close()
...
func TestSimulatedBackendGost_NonceAt(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_SendTransaction(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_TransactionByHash(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_EstimateGas(t *testing.T) {
	/*
...
func TestSimulatedBackendGost_EstimateGasWithPrice(t *testing.T) {
	key, _ := crypto.GenerateKey[gost3410.PrivateKey]()
	addr := crypto.PubkeyToAddress[gost3410.PublicKey](*key.Public())
...
func TestSimulatedBackendGost_HeaderByHash(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_HeaderByNumber(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_TransactionCount(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_TransactionInBlock(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_PendingNonceAt(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_TransactionReceipt(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
...
func TestSimulatedBackendGost_SuggestGasPrice(t *testing.T) {
	sim := NewSimulatedBackend[gost3410.PublicKey](
		core.GenesisAlloc{},
		10000000,
	)
...
func TestSimulatedBackendGost_PendingCodeAt(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
	sim := simTestBackendGost(testAddr)
	defer sim.Close()
	bgCtx := context.Background()
	...
	if !bytes.Equal(code, common.FromHex(deployedCodeGost)) {
		t.Errorf("code received did not match expected deployed code:\n expected %v\n actual %v", common.FromHex(deployedCodeGost), code)
	}
}

func TestSimulatedBackendGost_CodeAt(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
	sim := simTestBackendGost(testAddr)
	defer sim.Close()
	bgCtx := context.Background()
...
func TestSimulatedBackendGost_PendingAndCallContract(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
	sim := simTestBackendGost(testAddr)
	defer sim.Close()
	bgCtx := context.Background()
	...
	if !bytes.Equal(res, expectedReturnGost) || !strings.Contains(string(res), "hello world") {
...
func TestSimulatedBackendGost_CallContractRevert(t *testing.T) {
	testAddr := crypto.PubkeyToAddress[gost3410.PublicKey](*testKeyGost.Public())
	sim := simTestBackendGost(testAddr)
	defer sim.Close()
	bgCtx := context.Background()

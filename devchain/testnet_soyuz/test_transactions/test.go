...
func TestTransfer(){
	...
	jsonBytes, err := ioutil.ReadFile("../node1/keystore/UTC--2023-04-18T20-17-51.383099523Z--dbf94221bfadfcaa4ec0a4fa199ac377c136141b")
    if err != nil {
        log.Fatal(err)
    }
	key, err := keystore.DecryptKey[gost3410.PrivateKey,gost3410.PublicKey](jsonBytes, "")
	if err != nil {
		panic(err)
	}

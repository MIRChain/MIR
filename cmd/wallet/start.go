...
type ApproveTxRequest struct {
	Params     *core2.SignTxRequest[gost3410.PublicKey]
	ResponseCh chan *core2.SignTxResponse[gost3410.PublicKey]
}
...
func NewUI(ctx context.Context, uiClose chan bool, readyToStart chan string) *ClefUI {
	c := &ClefUI{}

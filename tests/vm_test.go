...
func TestVM(t *testing.T) {
	...
	vmt.walk(t, vmTestDir, func(t *testing.T, name string, test *VMTest[nist.PublicKey]) {
		withTrace(t, test.json.Exec.GasLimit, func(vmconfig vm.Config[nist.PublicKey]) error {

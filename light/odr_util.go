...
func GetHeaderByNumber[P crypto.PublicKey](ctx context.Context, odr OdrBackend[P], number uint64) (*types.Header, error) {
...
func GetUntrustedBlockLogs[P crypto.PublicKey](ctx context.Context, odr OdrBackend[P], header *types.Header) ([][]*types.Log, error) {
	// Retrieve the potentially incomplete receipts from disk or network

...
func TestProtocolHandshake(t *testing.T) {
	var (
		prv0, _ = crypto.GenerateKey[nist.PrivateKey]()
		pub0    = crypto.FromECDSAPub[nist.PublicKey](*prv0.Public())[1:]
		hs0     = &protoHandshake{Version: 3, ID: pub0, Caps: []Cap{{"a", 0}, {"b", 2}}}

		prv1, _ = crypto.GenerateKey[nist.PrivateKey]()
		pub1    = crypto.FromECDSAPub[nist.PublicKey](*prv1.Public())[1:]

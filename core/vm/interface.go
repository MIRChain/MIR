...
type CallContext [P crypto.PublicKey] interface {
	// Call another contract
	Call(env *EVM[P], me ContractRef, addr common.Address, data []byte, gas, value *big.Int) ([]byte, error)
	// Take another's contract code and execute within our own context
	CallCode(env *EVM[P], me ContractRef, addr common.Address, data []byte, gas, value *big.Int) ([]byte, error)
	// Same as CallCode except sender and value is propagated from parent to child scope
	DelegateCall(env *EVM[P], me ContractRef, addr common.Address, data []byte, gas *big.Int) ([]byte, error)
	// Create a new contract
	Create(env *EVM[P], me ContractRef, data []byte, gas, value *big.Int) ([]byte, common.Address, error)
}

...
var SimpleBin = ""
...
func (_Simple *SimpleTransactor) SetValue(opts *bind.TransactOpts, v *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function setValue(uint256 v) returns()
func (_Simple *SimpleSession) SetValue(v *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function setValue(uint256 v) returns()
func (_Simple *SimpleTransactorSession) SetValue(v *big.Int) (*types.Transaction, error) {
	return _Simple.Contract.SetValue(&_Simple.TransactOpts, v)
}

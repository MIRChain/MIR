...
func BenchmarkFilters(b *testing.B) {
	...
	chain, receipts := core.GenerateChain[nist.PublicKey](params.TestChainConfig, genesis,  ethash.NewFaker[nist.PublicKey](), db, 100010, func(i int, gen *core.BlockGen) {
		switch i {
		case 2403:
...
func TestFilters(t *testing.T) {
	...
	chain, receipts := core.GenerateChain[nist.PublicKey](params.TestChainConfig, genesis,  ethash.NewFaker[nist.PublicKey](), db, 1000, func(i int, gen *core.BlockGen) {
		switch i {
		case 1:
			receipt := types.NewReceipt(nil, false, 0)
			receipt.Logs = []*types.Log{
...
func TestMPSFilters(t *testing.T) {
	...
	genesis := core.GenesisBlockForTesting(db, addr, big.NewInt(1000000))
	chain, receipts := core.GenerateChain[nist.PublicKey](params.QuorumMPSTestChainConfig, genesis,  ethash.NewFaker[nist.PublicKey](), db, 1000, func(i int, gen *core.BlockGen) {
		switch i {
		case 1:
